 ...
 * GlpiProjectteams
 *
 * @ORM\Table(name="glpi_projectteams", uniqueConstraints={@ORM\UniqueConstraint(name="unicity", columns={"projects_id", "itemtype", "items_id"})}, indexes={@ORM\Index(name="item", columns={"itemtype", "items_id"})})
 * @ORM\Entity
 */
class GlpiProjectteams
{
    /**
     * @var integer
     *
