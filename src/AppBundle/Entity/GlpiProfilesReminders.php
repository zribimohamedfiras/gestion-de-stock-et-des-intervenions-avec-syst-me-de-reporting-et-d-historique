...
/**
 * GlpiProfilesReminders
 *
 * @ORM\Table(name="glpi_profiles_reminders", indexes={@ORM\Index(name="reminders_id", columns={"reminders_id"}), @ORM\Index(name="profiles_id", columns={"profiles_id"}), @ORM\Index(name="entities_id", columns={"entities_id"}), @ORM\Index(name="is_recursive", columns={"is_recursive"})})
 * @ORM\Entity
 */
class GlpiProfilesReminders
{
    /**
     * @var integer
     *
