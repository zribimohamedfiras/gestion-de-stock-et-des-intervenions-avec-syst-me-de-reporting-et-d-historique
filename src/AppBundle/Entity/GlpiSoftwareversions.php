 ...
 *
 * @ORM\Table(name="glpi_softwareversions", indexes={@ORM\Index(name="name", columns={"name"}), @ORM\Index(name="softwares_id", columns={"softwares_id"}), @ORM\Index(name="states_id", columns={"states_id"}), @ORM\Index(name="entities_id", columns={"entities_id"}), @ORM\Index(name="is_recursive", columns={"is_recursive"}), @ORM\Index(name="operatingsystems_id", columns={"operatingsystems_id"}), @ORM\Index(name="date_mod", columns={"date_mod"}), @ORM\Index(name="date_creation", columns={"date_creation"})})
 * @ORM\Entity
 */
