 ...
 *
 * @ORM\Table(name="glpi_devicenetworkcards", indexes={@ORM\Index(name="designation", columns={"designation"}), @ORM\Index(name="manufacturers_id", columns={"manufacturers_id"}), @ORM\Index(name="entities_id", columns={"entities_id"}), @ORM\Index(name="is_recursive", columns={"is_recursive"}), @ORM\Index(name="date_mod", columns={"date_mod"}), @ORM\Index(name="date_creation", columns={"date_creation"})})
 * @ORM\Entity
 */
class GlpiDevicenetworkcards
{
     ...
     * Set macDefault
     *
     * @param string $macDefault
     *
     * @return GlpiDevicenetworkcards
     */
    public function setMacDefault($macDefault)
    {
